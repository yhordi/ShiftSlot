...
RSpec.describe ShiftsController, type: :controller do
  ...
  let(:show) { FactoryGirl.create(:show, venue_id: venue.id, info: venue.hooks + ' alkdsjfl lakdfjioj1r98hf 398492', organization_id: org.id) }
  ...
  describe '#update' do
    context 'a signed in worker' do
      ...
      context 'on failure' do
        let(:show_tomorrow) { FactoryGirl.create :show, start: DateTime.tomorrow, venue: venue, info: venue.hooks + ' 1438 lasdkf98y1 08172hfcoh ', organization_id: org.id }
